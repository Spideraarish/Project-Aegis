...
### Backend & AI
- **Python & FastAPI**: High-performance asynchronous API and WebSocket server.
...
2. **Start the Frontend:**
   ...
   npm run dev
   ```
   The dashboard will be available at `https://project-aegis-ten.vercel.app/`.
...
## Architecture & Threat Containment
